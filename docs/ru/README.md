...
| [`mergeSorted`](multi-iteration.md#merge-sorted)             | Лениво объединяет отсортированные коллекции                                                  | `Multi::mergeSorted(...$iterables)`          |
| [`mergeSortedBy`](multi-iteration.md#merge-sorted-by)        | Лениво объединяет коллекции, отсортированные по проекции                                     | `Multi::mergeSortedBy($keyFunc, ...$iterables)` |
...
| [`unzip`](multi-iteration.md#unzip)                           | Транспонирует последовательность строк в столбцы (обратная операция к zip)                  | `Multi::unzip($rows)`                        |
...
| [`dropLast`](single-iteration.md#drop-last)                                     | Перебирает все элементы, кроме последних N                                   | `Single::dropLast($data, $count)`                           |
...
| [`dropWhileWithKeys`](single-iteration.md#drop-while-with-keys)                 | Пропускает элементы по предикату значения и ключа                            | `Single::dropWhileWithKeys($data, $predicate)`              |
| [`enumerate`](single-iteration.md#enumerate)                                    | Итерирует пары `[индекс, значение]`                                          | `Single::enumerate($data, [$start])`                        |
| [`filter`](single-iteration.md#filter)                                          | Возвращает только те элементы, для которых предикат возвращает истину        | `Single::filter($data, $predicate)`                         |
...
| [`filterWithKeys`](single-iteration.md#filter-with-keys)                        | Фильтрация предикатом, учитывающим значение и ключ                           | `Single::filterWithKeys($data, $predicate)`                 |
| [`flatMap`](single-iteration.md#flat-map)                                       | Отображение коллекции с уплощением результата на 1 уровень вложенности       | `Single::flatMap($data, $mapper)`                           |
| [`flatMapWithKeys`](single-iteration.md#flat-map-with-keys)                     | Отображение, учитывающее ключи, с уплощением результата                      | `Single::flatMapWithKeys($data, $func)`                     |
| [`flatten`](single-iteration.md#flatten)                                        | Многоуровневое уплощение коллекции                                           | `Single::flatten($data, [$dimensions])`                     |
| [`groupAdjacentBy`](single-iteration.md#group-adjacent-by)                      | Группирует подряд идущие элементы по извлечённому ключу                      | `Single::groupAdjacentBy($data, $keyFn)`                    |
...
| [`mapWithKeys`](single-iteration.md#map-with-keys)                              | Отображение функцией, учитывающей значение и ключ                            | `Single::mapWithKeys($data, $func)`                         |
...
| [`splitWhen`](single-iteration.md#split-when)                                   | Разбивает коллекцию на группы при срабатывании предиката                     | `Single::splitWhen($data, $predicate)`                      |
| [`string`](single-iteration.md#string)                                          | Итерирует строку посимвольно                                                 | `Single::string($string)`                                   |
| [`takeLast`](single-iteration.md#take-last)                                     | Перебирает последние N элементов                                            | `Single::takeLast($data, $count)`                           |
| [`takeWhile`](single-iteration.md#take-while)                                   | Отдает элементы, пока предикат возвращает истину                             | `Single::takeWhile($data, $predicate)`                      |
| [`takeWhileWithKeys`](single-iteration.md#take-while-with-keys)                 | Отдает элементы по предикату значения и ключа                                | `Single::takeWhileWithKeys($data, $predicate)`              |
| [`windowed`](single-iteration.md#windowed)                                      | Итерирует скользящие окна элементов                                          | `Single::windowed($data, $size, [$step], [$partial])`       |
| [`withFirst`](single-iteration.md#with-first)                                   | Сопоставляет каждому элементу флаг «первый»                                  | `Single::withFirst($data)`                                  |
| [`withFirstAndLast`](single-iteration.md#with-first-and-last)                   | Сопоставляет каждому элементу флаги «первый»/«последний»                     | `Single::withFirstAndLast($data)`                           |
| [`withLast`](single-iteration.md#with-last)                                     | Сопоставляет каждому элементу флаг «последний»                               | `Single::withLast($data)`                                   |
...
| [`generate`](infinite-iteration.md#generate)            | Бесконечно отдаёт значения, возвращаемые поставщиком | `Infinite::generate($supplier)` |
...
| [`repeat`](infinite-iteration.md#repeat-infinite)       | Бесконечно повторяет данное значение                 | `Infinite::repeat($item)`        |
...
| [`reservoirSample`](random-iteration.md#reservoir-sample)         | Однопроходная равномерная случайная выборка | `Random::reservoirSample($data, $size, [$engine])` |
...
| [`sample`](random-iteration.md#sample)                            | Случайная выборка без повторений         | `Random::sample($data, $size, [$engine])`  |
...
| [`frequenciesBy`](math-iteration.md#frequencies-by)                     | Распределение частот по функции-ключу | `Math::frequenciesBy($data, $keyFunc, [$strict])` |
...
| [`relativeFrequenciesBy`](math-iteration.md#relative-frequencies-by)    | Относительное распределение частот по функции-ключу | `Math::relativeFrequenciesBy($data, $keyFunc, [$strict])` |
...
| [`distinctBy`](set-iteration.md#distinct-by)                                               | Фильтрует коллекцию, сохраняя только уникальные значения по компаратору | `Set::distinctBy($data, $compareBy)`                         |
| [`duplicates`](set-iteration.md#duplicates)                                                 | Возвращает значения, встречающиеся более одного раза                  | `Set::duplicates($data, [$strict])`                          |
| [`duplicatesBy`](set-iteration.md#duplicates-by)                                            | Возвращает дубликаты по извлечённому ключу                            | `Set::duplicatesBy($data, $keyFn)`                           |
...
| [`shuffle`](sort-iteration.md#shuffle)           | Итерирует коллекцию в случайном порядке            | `Sort::shuffle($data, [$engine])`   |
...
| [`memoize`](transform-iteration.md#memoize)                                | Лениво кэширует коллекцию для повторных обходов                | `Transform::memoize($data)`                                     |
...
| [`allMatchWithKeys`](summary.md#all-match-with-keys)                                    | Истинно, если предикат значения и ключа истинен для всех элементов                                  | `Summary::allMatchWithKeys($data, $predicate)`    |
| [`allEqual`](summary.md#all-equal)                                                      | Истинно, если все элементы имеют одну идентичность                                                   | `Summary::allEqual($data, [$strict])`             |
| [`allEqualBy`](summary.md#all-equal-by)                                                 | Истинно, если все проекции имеют одну идентичность                                                   | `Summary::allEqualBy($data, $keyFunc, [$strict])` |
...
| [`anyMatchWithKeys`](summary.md#any-match-with-keys)                                    | Истинно, если предикат значения и ключа истинен хотя бы для одного элемента                          | `Summary::anyMatchWithKeys($data, $predicate)`    |
...
| [`atLeastN`](summary.md#at-least-n)                                                     | Истинно, если предикат возвращает истину как минимум для N элементов                                 | `Summary::atLeastN($data, $n, [$predicate])`      |
| [`atMostN`](summary.md#at-most-n)                                                       | Истинно, если предикат возвращает истину не более чем для N элементов                                | `Summary::atMostN($data, $n, [$predicate])`       |
...
| [`endsWith`](summary.md#ends-with)                                                      | Истинно, если коллекция заканчивается заданным суффиксом                                             | `Summary::endsWith($data, $suffix)`               |
| [`endsWithCoercive`](summary.md#ends-with-coercive)                                     | Истинно, если коллекция заканчивается заданным суффиксом (в режиме приведения типов)                 | `Summary::endsWithCoercive($data, $suffix)`       |
...
| [`isSortedBy`](summary.md#is-sorted-by)                                                 | Истинно, если коллекция отсортирована по функции-ключу в прямом порядке                              | `Summary::isSortedBy($data, $keyFunc)`            |
| [`isReversedBy`](summary.md#is-reversed-by)                                             | Истинно, если коллекция отсортирована по функции-ключу в обратном порядке                            | `Summary::isReversedBy($data, $keyFunc)`          |
...
| [`noneMatchWithKeys`](summary.md#none-match-with-keys)                                  | Истинно, если предикат значения и ключа не истинен ни для одного элемента                            | `Summary::noneMatchWithKeys($data, $predicate)`   |
...
| [`startsWith`](summary.md#starts-with)                                                  | Истинно, если коллекция начинается с заданного префикса                                              | `Summary::startsWith($data, $prefix)`             |
| [`startsWithCoercive`](summary.md#starts-with-coercive)                                 | Истинно, если коллекция начинается с заданного префикса (в режиме приведения типов)                  | `Summary::startsWithCoercive($data, $prefix)`     |
...
| [`toCountBy`](reduce.md#to-count-by)                        | Количества, сгруппированные по функции-ключу                                        | `Reduce::toCountBy($data, $keyFunc)`                          |
...
| [`append`](stream.md#append)                                                             | Добавляет значения в конец потока                                                                            | `$stream->append(...$values)`                                                     |
...
| [`distinctBy`](stream.md#distinct-by)                                                    | Фильтрует коллекцию, сохраняя только уникальные значения по компаратору                                      | `$stream->distinctBy($compareBy)`                                                 |
| [`dropLast`](stream.md#drop-last)                                                        | Перебирает все элементы потока, кроме последних N                                                            | `$stream->dropLast($count)`                                                       |
...
| [`dropWhileWithKeys`](stream.md#drop-while-with-keys)                                    | Пропускает элементы по предикату значения и ключа                                                            | `$stream->dropWhileWithKeys($predicate)`                                          |
| [`duplicates`](stream.md#duplicates)                                                     | Возвращает значения, встречающиеся более одного раза                                                         | `$stream->duplicates([$strict])`                                                  |
| [`duplicatesBy`](stream.md#duplicates-by)                                                | Возвращает дубликаты по извлечённому ключу                                                                   | `$stream->duplicatesBy($keyFn)`                                                   |
| [`enumerate`](stream.md#enumerate)                                                       | Итерирует пары `[индекс, значение]`                                                                          | `$stream->enumerate([$start])`                                                    |
| [`filter`](stream.md#filter)                                                             | Возвращает из коллекции только те элементы, для которых предикат возвращает истину                           | `$stream->filter($predicate)`                                                     |
...
| [`filterWithKeys`](stream.md#filter-with-keys)                                           | Фильтрация предикатом, учитывающим значение и ключ                                                           | `$stream->filterWithKeys($predicate)`                                             |
...
| [`flatMapWithKeys`](stream.md#flat-map-with-keys)                                        | Отображение, учитывающее ключи, с уплощением результата                                                      | `$stream->flatMapWithKeys($func)`                                                 |
...
| [`frequenciesBy`](stream.md#frequencies-by)                                              | Частота вхождений по функции-ключу                                                                           | `$stream->frequenciesBy($keyFunc, [$strict])`                                     |
| [`groupAdjacentBy`](stream.md#group-adjacent-by)                                         | Группирует подряд идущие элементы по извлечённому ключу                                                      | `$stream->groupAdjacentBy($keyFn)`                                                |
...
| [`mapWithKeys`](stream.md#map-with-keys)                                                 | Отображение функцией, учитывающей значение и ключ                                                            | `$stream->mapWithKeys($func)`                                                     |
...
| [`memoize`](stream.md#memoize)                                                           | Лениво кэширует поток в текущей точке pipeline                                                              | `$stream->memoize()`                                                              |
| [`mergeSortedWith`](stream.md#merge-sorted-with)                                         | Сливает отсортированный поток с дополнительными источниками                                                 | `$stream->mergeSortedWith(...$iterables)`                                         |
| [`mergeSortedByWith`](stream.md#merge-sorted-by-with)                                    | Сливает источники, отсортированные по проекции                                                              | `$stream->mergeSortedByWith($keyFunc, ...$iterables)`                             |
| [`padLeft`](stream.md#pad-left)                                                          | Дополняет поток слева до указанной минимальной длины                                                         | `$stream->padLeft($length, $fill)`                                                |
| [`padRight`](stream.md#pad-right)                                                        | Дополняет поток справа до указанной минимальной длины                                                        | `$stream->padRight($length, $fill)`                                               |
...
| [`prepend`](stream.md#prepend)                                                           | Добавляет значения в начало потока                                                                           | `$stream->prepend(...$values)`                                                    |
...
| [`relativeFrequenciesBy`](stream.md#relative-frequencies-by)                             | Относительная частота вхождений по функции-ключу                                                             | `$stream->relativeFrequenciesBy($keyFunc, [$strict])`                             |
| [`reservoirSample`](stream.md#reservoir-sample)                                          | Однопроходная равномерная случайная выборка (энергичная)                                                    | `$stream->reservoirSample($size, [$engine])`                                      |
...
| [`sample`](stream.md#sample)                                                             | Случайная выборка из $size элементов потока без повторений                                                   | `$stream->sample($size, [$engine])`                                               |
| [`shuffle`](stream.md#shuffle)                                                           | Рандомизирует порядок элементов потока                                                                       | `$stream->shuffle([$engine])`                                                     |
...
| [`splitWhen`](stream.md#split-when)                                                      | Разбивает поток на группы при срабатывании предиката                                                         | `$stream->splitWhen($predicate)`                                                  |
...
| [`takeLast`](stream.md#take-last)                                                        | Перебирает последние N элементов потока                                                                      | `$stream->takeLast($count)`                                                       |
| [`takeWhile`](stream.md#take-while)                                                      | Отдает элементы из коллекции, пока предикат возвращает истину                                                | `$stream->takeWhile($predicate)`                                                  |
| [`takeWhileWithKeys`](stream.md#take-while-with-keys)                                    | Отдает элементы по предикату значения и ключа                                                               | `$stream->takeWhileWithKeys($predicate)`                                          |
...
| [`unzip`](stream.md#unzip)                                                               | Транспонирует строки потока в столбцы (обратная операция к zip)                                              | `$stream->unzip()`                                                                |
| [`windowed`](stream.md#windowed)                                                         | Итерирует скользящие окна элементов                                                                         | `$stream->windowed($size, [$step], [$partial])`                                   |
| [`withFirst`](stream.md#with-first)                                                      | Сопоставляет каждому элементу флаг «первый»                                                                 | `$stream->withFirst()`                                                            |
| [`withFirstAndLast`](stream.md#with-first-and-last)                                      | Сопоставляет каждому элементу флаги «первый»/«последний»                                                    | `$stream->withFirstAndLast()`                                                     |
| [`withLast`](stream.md#with-last)                                                        | Сопоставляет каждому элементу флаг «последний»                                                              | `$stream->withLast()`                                                             |
...
| [`allMatchWithKeys`](stream.md#all-match-with-keys)                                     | Истинно, если предикат значения и ключа истинен для всех элементов                                  | `$stream->allMatchWithKeys($predicate)`               |
| [`allEqual`](stream.md#all-equal)                                                       | Истинно, если все элементы равны по выбранным правилам идентичности                                  | `$stream->allEqual([$strict])`                        |
| [`allEqualBy`](stream.md#all-equal-by)                                                  | Истинно, если все проекции равны                                                                      | `$stream->allEqualBy($keyFunc, [$strict])`            |
...
| [`anyMatchWithKeys`](stream.md#any-match-with-keys)                                     | Истинно, если предикат значения и ключа истинен хотя бы для одного элемента                          | `$stream->anyMatchWithKeys($predicate)`               |
...
| [`atLeastN`](stream.md#at-least-n)                                                    | Истинно, если предикат возвращает истину как минимум для N элементов                                 | `$stream->atLeastN($n, [$predicate])`                 |
| [`atMostN`](stream.md#at-most-n)                                                      | Истинно, если предикат возвращает истину не более чем для N элементов                                | `$stream->atMostN($n, [$predicate])`                  |
...
| [`endsWith`](stream.md#ends-with)                                                     | Истинно, если поток заканчивается заданным суффиксом                                                 | `$stream->endsWith($suffix)`                          |
| [`endsWithCoercive`](stream.md#ends-with-coercive)                                    | Истинно, если поток заканчивается заданным суффиксом (в режиме приведения типов)                     | `$stream->endsWithCoercive($suffix)`                  |
...
| [`isSortedBy`](stream.md#is-sorted-by)                                                | Истинно, если коллекция отсортирована по функции-ключу в прямом порядке                              | `$stream->isSortedBy($keyFunc)`                       |
| [`isReversedBy`](stream.md#is-reversed-by)                                            | Истинно, если коллекция отсортирована по функции-ключу в обратном порядке                            | `$stream->isReversedBy($keyFunc)`                     |
...
| [`noneMatchWithKeys`](stream.md#none-match-with-keys)                                   | Истинно, если предикат значения и ключа не истинен ни для одного элемента                            | `$stream->noneMatchWithKeys($predicate)`              |
...
| [`startsWith`](stream.md#starts-with)                                                 | Истинно, если поток начинается с заданного префикса                                                  | `$stream->startsWith($prefix)`                        |
| [`startsWithCoercive`](stream.md#starts-with-coercive)                                | Истинно, если поток начинается с заданного префикса (в режиме приведения типов)                      | `$stream->startsWithCoercive($prefix)`                |
...
| [`toCountBy`](stream.md#to-count-by)                    | Количества, сгруппированные по функции-ключу                        | `$stream->toCountBy($keyFunc)`                          |
...
| [`callForEachWithKeys`](stream.md#call-for-each-with-keys) | Вызывает callback для каждого значения и ключа      | `$stream->callForEachWithKeys($function)`            |
...
| [`peekWithKeys`](stream.md#peek-with-keys)        | Ленивый просмотр каждого значения и ключа                         | `$stream->peekWithKeys($peekFunc)` |
