...
class FilterUniqueTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function dataProviderForArray(): array
    {
        return [
            ...
            [   [[1], 'a' => [1, 2]],   true,       [[1], [1, 2]]               ],
            [   [[1], 'a' => [1, 2]],   false,      [[1], [1, 2]]               ],
            [   [false, null, 0, 0.0, ''],      true,    [false, null, 0, 0.0, '']   ],
            [   [false, null, 0, 0.0, ''],      false,   [false]                     ],
            [   [true, 1, '1', 1.0, '1.0'],     true,    [true, 1, '1', 1.0, '1.0']  ],
            [   [true, 1, '1', 1.0, '1.0'],     false,   [true, 1.0]                 ],
            [   [true, 1, '1', 1.1, '1.1'],     true,    [true, 1, '1', 1.1, '1.1']  ],
            [   [true, 1, '1', 1.1, '1.1'],     false,   [true, 1.1]                 ],
            [
    ...
    public function dataProviderForGenerators(): array
    {
        ...
        return [
            ...
            [   $gen([false, null, 0, 0.0, '']),      true,    [false, null, 0, 0.0, '']   ],
            [   $gen([false, null, 0, 0.0, '']),      false,   [false]                     ],
            [   $gen([true, 1, '1', 1.0, '1.0']),     true,    [true, 1, '1', 1.0, '1.0']  ],
            [   $gen([true, 1, '1', 1.0, '1.0']),     false,   [true, 1.0]                 ],
            [   $gen([true, 1, '1', 1.1, '1.1']),     true,    [true, 1, '1', 1.1, '1.1']  ],
            [   $gen([true, 1, '1', 1.1, '1.1']),     false,   [true, 1.1]                 ],
            [
    ...
    public function dataProviderForIterators(): array
    {
        ...
        return [
            ...
            [   $iter([false, null, 0, 0.0, '']),      true,    [false, null, 0, 0.0, '']   ],
            [   $iter([false, null, 0, 0.0, '']),      false,   [false]                     ],
            [   $iter([true, 1, '1', 1.0, '1.0']),     true,    [true, 1, '1', 1.0, '1.0']  ],
            [   $iter([true, 1, '1', 1.0, '1.0']),     false,   [true, 1.0]                 ],
            [   $iter([true, 1, '1', 1.1, '1.1']),     true,    [true, 1, '1', 1.1, '1.1']  ],
            [   $iter([true, 1, '1', 1.1, '1.1']),     false,   [true, 1.1]                 ],
            [
    ...
    public function dataProviderForTraversables(): array
    {
        ...
        return [
            ...
            [   $trav([false, null, 0, 0.0, '']),      true,    [false, null, 0, 0.0, '']   ],
            [   $trav([false, null, 0, 0.0, '']),      false,   [false]                     ],
            [   $trav([true, 1, '1', 1.0, '1.0']),     true,    [true, 1, '1', 1.0, '1.0']  ],
            [   $trav([true, 1, '1', 1.0, '1.0']),     false,   [true, 1.0]                 ],
            [   $trav([true, 1, '1', 1.1, '1.1']),     true,    [true, 1, '1', 1.1, '1.1']  ],
            [   $trav([true, 1, '1', 1.1, '1.1']),     false,   [true, 1.1]                 ],
            [
