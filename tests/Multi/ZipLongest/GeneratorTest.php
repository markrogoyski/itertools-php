...
{
    /**
     * @test         zipLongest with two generators of the same size
     * @dataProvider dataProviderForZipLongestTwoGeneratorsSameSize
     * @param        \Generator $generator1
     * @param        \Generator $generator2
     * @param        array      $expected
     */
    public function testZipLongestTwoGeneratorsSameSize(\Generator $generator1, \Generator $generator2, array $expected): void
    {
        // Given
        $result = [];

        // When
        foreach (Multi::zipLongest($generator1, $generator2) as [$value1, $value2]) {
     ...
     * @return array
     */
    public static function dataProviderForZipLongestTwoGeneratorsSameSize(): array
    {
        return [
            [
